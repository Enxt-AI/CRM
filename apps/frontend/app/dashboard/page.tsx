    ...
    <div className="space-y-8 pb-8">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 p-8 text-white shadow-xl">
        ...
        <div className="relative">
          ...
          <p className="mt-2 text-neutral-300 max-w-2xl">
            Track your sales pipeline, manage relationships, and close more deals
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-white hover:shadow-xl transition-shadow">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-blue-900">{leadStats?.total ?? 0}</div>
            <p className="mt-1 text-sm text-blue-700">
              {Object.entries(leadStats?.byStage || {}).map(([stage, count]) => (
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-white hover:shadow-xl transition-shadow">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-green-900">
              {(leadStats?.byPriority?.HIGH || 0) + (leadStats?.byPriority?.URGENT || 0)}
            </div>
            <p className="mt-1 text-sm text-green-700">Leads need attention</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-50 to-white hover:shadow-xl transition-shadow">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-purple-900">
              {Object.keys(leadStats?.bySource || {}).length}
            </div>
            <p className="mt-1 text-sm text-purple-700">Active channels</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 to-white hover:shadow-xl transition-shadow">
          ...
          <CardContent>
            ...
            <p className="mt-1 text-sm text-orange-700">Track performance</p>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent className="space-y-3">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-neutral-500">Book time with clients</p>
              </div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-sm font-medium text-neutral-700">Deals</span>
              </button>
